...
import { IconArrowNarrowLeft, IconArrowNarrowRight, IconX } from "./IconX";
        ...
        >
          ...
          <div
            className={cn(
              ...
              "lg:max-w-[80%] max-w-full mx-auto"
            )}
          >
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="text-base font-medium text-neutral-800 dark:text-white"
              >
                {card.category}
              </motion.p>
              <motion.p
...
export function AppleCardsCarouselDemo() {
  ...
  return (
    <div className="w-full h-full mt-20">
      <h2 className="lg:max-w-[80%] pl-4 mx-auto text-2xl md:text-5xl font-bold text-neutral-800 ">
        Mas productos interesantes
      </h2>
